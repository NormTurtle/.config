...
o.guifont = "Sarasa Mono Slab HC Nerd Font,Delugia:h13" -- Font and size
--Control Panel\Appearance and Personalisation\Fonts\-- o.guifont = "Maple Mono SC NF,Delugia:h13" -- Font and size
-- o.guifont = "Delugia:h14" -- Font and size
